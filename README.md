...
### 3. الحسابات التلقائية للأعضاء الجدد (تم إضافتها مؤخراً)
عند قيام أمين المكتبة بإضافة عضو جديد من الواجهة الرسومية، يقوم النظام تلقائياً بإنشاء حساب دخول له بالمواصفات التالية:
*   **اسم المستخدم:** البريد الإلكتروني للعضو (وفي حال عدم توفره، يتم استخدام الاسم التعريفي الافتراضي `member_[id]`).
...
*   **شروط ظهور زر الشراء:** لكي يظهر زر الشراء أو طلب الشراء للكتاب في لوحة التحكم، يجب أن يكون الكتاب معلماً كـ **"معروض للبيع"** ويكون **"متاحاً"** (غير مستعار) في نفس الوقت من خلال صفحة إضافة/تعديل الكتب.

---

## 📄 رخصة المشروع
هذا المشروع متاح تحت رخصة **gentech**. لمزيد من التفاصيل يرجى مراجعة ملف الرخصة.
